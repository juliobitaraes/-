...
app.renderSidebar = function() {
    ...
    const menus = {
        admin: [{ id: 'dashboard', icon: 'fa-home', label: 'Dashboard' }, { id: 'diario', icon: 'fa-book', label: 'Diário' }, { id: 'relatorios', icon: 'fa-chart-bar', label: 'Relatórios' }, { id: 'notificacoes', icon: 'fa-bell', label: 'Notificações' }, { id: 'usuarios', icon: 'fa-users-cog', label: 'Usuários' }, { id: 'manual', icon: 'fa-book-open', label: 'Manual' }, { id: 'turmas', icon: 'fa-chalkboard', label: 'Turmas' }, { id: 'alunos', icon: 'fa-user-graduate', label: 'Alunos' }, { id: 'materiais', icon: 'fa-book', label: 'Materiais' }, { id: 'provas', icon: 'fa-file-signature', label: 'Provas' }, { id: 'atividades', icon: 'fa-tasks', label: 'Atividades EAD' }, { id: 'trabalhos', icon: 'fa-briefcase', label: 'Trabalhos' }, { id: 'forum', icon: 'fa-users', label: 'Fórum' }, { id: 'cadastro', icon: 'fa-user-cog', label: 'Cadastro' }],
        professor: [{ id: 'dashboard', icon: 'fa-home', label: 'Dashboard' }, { id: 'diario', icon: 'fa-book', label: 'Diário' }, { id: 'relatorios', icon: 'fa-chart-bar', label: 'Relatórios' }, { id: 'notificacoes', icon: 'fa-bell', label: 'Notificações' }, { id: 'alunos', icon: 'fa-user-graduate', label: 'Meus Alunos' }, { id: 'materiais', icon: 'fa-book', label: 'Materiais' }, { id: 'provas', icon: 'fa-file-signature', label: 'Provas' }, { id: 'atividades', icon: 'fa-tasks', label: 'Atividades EAD' }, { id: 'trabalhos', icon: 'fa-briefcase', label: 'Trabalhos' }, { id: 'forum', icon: 'fa-users', label: 'Fórum' }, { id: 'cadastro', icon: 'fa-user-cog', label: 'Cadastro' }],
        secretaria: [{ id: 'dashboard', icon: 'fa-home', label: 'Dashboard' }, { id: 'diario', icon: 'fa-book', label: 'Diário' }, { id: 'relatorios', icon: 'fa-chart-bar', label: 'Relatórios' }, { id: 'manual', icon: 'fa-book-open', label: 'Manual' }, { id: 'turmas', icon: 'fa-chalkboard', label: 'Turmas' }, { id: 'alunos', icon: 'fa-user-graduate', label: 'Alunos' }, { id: 'forum', icon: 'fa-users', label: 'Fórum' }, { id: 'cadastro', icon: 'fa-user-cog', label: 'Cadastro' }],
        aluno: [{ id: 'dashboard', icon: 'fa-home', label: 'Dashboard' }, { id: 'diario', icon: 'fa-book', label: 'Diário' }, { id: 'materiais', icon: 'fa-book', label: 'Materiais' }, { id: 'provas', icon: 'fa-file-signature', label: 'Provas' }, { id: 'atividades', icon: 'fa-tasks', label: 'Atividades EAD' }, { id: 'trabalhos', icon: 'fa-briefcase', label: 'Trabalhos' }, { id: 'forum', icon: 'fa-users', label: 'Fórum' }, { id: 'cadastro', icon: 'fa-user-cog', label: 'Cadastro' }]
    };
